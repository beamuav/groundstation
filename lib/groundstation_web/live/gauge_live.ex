defmodule GroundStationWeb.GaugeLive do
  ...
  def render(assigns) do
    ...
    <svg viewBox="0 0 100 30" xmlns="http://www.w3.org/2000/svg">
      ...
      <g id="lines">
        <defs>
          <marker id="marker" markerWidth="2" markerHeight="5" refY="5" orient="auto">
            <line x1="0" y1="0" x2="0" y2="20" stroke="white" />
          </marker>
        </defs>
        <line id="gauge-range" x1="1" y1="25" x2="98" y2="25" stroke="white" marker-start="url(#marker)" marker-end="url(#marker)" />
